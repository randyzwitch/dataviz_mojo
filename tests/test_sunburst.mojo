...
def test_render_sunburst_matches_hand_derived_ring_sectors() raises:
    ...
    var c = render(sunburst(ids, parents, values, theme=t, width=400, height=300))
...
def test_render_sunburst_raises_on_multiple_roots() raises:
    ...
    with assert_raises():
        _ = render(sunburst(ids, parents, values, width=200, height=150))
...
def test_render_sunburst_empty_data_only_fills_background() raises:
    ...
    var c = render(sunburst(ids, parents, values, width=100, height=80))
