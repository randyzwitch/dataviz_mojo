...
def main() raises:
    ...
    var plot = (
        ...
        .labels(title="Readings by Temperature")
        .theme(Theme(continuous_legend_bar_width=28, continuous_legend_bar_height=220))
    )
    save(plot, "docs/src/examples/out_continuous_legend_size.svg")
