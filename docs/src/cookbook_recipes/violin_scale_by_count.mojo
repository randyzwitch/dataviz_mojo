...
def main() raises:
    ...
    var deal_sizes: List[List[Float64]] = [
        [42.0, 45.0, 40.0, 48.0, 43.0, 46.0, 41.0, 47.0, 44.0, 45.0, 42.0, 46.0, 43.0, 48.0, 44.0, 41.0, 45.0, 47.0],
        [50.0, 55.0, 48.0, 52.0, 51.0, 53.0, 49.0, 54.0, 50.0, 52.0, 51.0, 53.0, 49.0, 54.0, 50.0],
    ...
    var plot = violin(
        ...
        subtitle="Width reflects sample count -- Rural's 3 deals draw a visibly thinner violin",
    )
