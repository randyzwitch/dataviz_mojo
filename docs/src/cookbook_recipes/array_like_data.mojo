...
def main() raises:
    ...
    var raw_x: List[Float64] = [1.0, 1.0, 2.0, 2.0, 3.0, 3.0, 4.0, 4.0, 5.0, 5.0]
    var raw_y: List[Float64] = [1.0, 1.1, 2.0, 2.1, 3.0, 3.1, 4.0, 4.1, 5.0, 5.1]
    ...
    var plot = (
        ...
        .mark_line()
        .encode(x=x, y=y)
        .labels(title="Every-Other Sensor Reading", x_title="Sample", y_title="Value")
    )
