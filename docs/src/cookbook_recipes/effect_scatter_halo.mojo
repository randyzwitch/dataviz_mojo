...
def main() raises:
    ...
    var y: List[Float64] = [12.0, 13.5, 12.8, 15.0, 14.2, 16.5, 15.8, 17.0, 16.2, 18.5]

    var plot = effect_scatter(
        x, y, theme=Theme(halo_alpha=35), title="Cluster Readings", subtitle="A dimmer halo for dense, overlapping points"
    )
