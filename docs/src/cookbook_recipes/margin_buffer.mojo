...
def main() raises:
    ...
    var revenue: List[Float64] = [1250000.0, 1480000.0, 1390000.0, 1620000.0, 1750000.0, 1690000.0]

    var plot = (
        Plot()
        .mark_line()
        .encode(x=x, y=revenue)
        .labels(title="Monthly Revenue", subtitle="Extra padding between wide tick labels and the axis line")
