...
![Stacked Bar](out_stacked_bar.svg)

## Run it

```sh
mojo run -I . examples/stacked_bar.mojo
```
...
[View `stacked_bar.mojo` on GitHub](https://github.com/randyzwitch/dataviz_mojo/blob/main/examples/stacked_bar.mojo)
