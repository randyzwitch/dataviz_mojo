...
![Line Smoothing](out_line_smoothing.svg)

## Run it

```sh
mojo run -I . examples/line_smoothing.mojo
```
...
[View `line_smoothing.mojo` on GitHub](https://github.com/randyzwitch/dataviz_mojo/blob/main/examples/line_smoothing.mojo)
