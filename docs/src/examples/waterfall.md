...
![Waterfall](out_waterfall.svg)

## Run it

```sh
mojo run -I . examples/waterfall.mojo
```
...
[View `waterfall.mojo` on GitHub](https://github.com/randyzwitch/dataviz_mojo/blob/main/examples/waterfall.mojo)
