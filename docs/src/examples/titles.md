...
![Titles & Axis Labels](out_titles.svg)

## Run it

```sh
mojo run -I . examples/titles.mojo
```
...
[View `titles.mojo` on GitHub](https://github.com/randyzwitch/dataviz_mojo/blob/main/examples/titles.mojo)
