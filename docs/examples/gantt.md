...
```sh
mojo run -I . examples/gantt.mojo
```
...
def main() raises:
    ...
    var raster_plot = Plot().mark_gantt().encode_gantt(tasks, start, end).theme(
    ...
    print("wrote examples/out_gantt.bmp and out_gantt.svg")
```

[View `gantt.mojo` on GitHub](https://github.com/randyzwitch/dataviz_mojo/blob/main/examples/gantt.mojo)