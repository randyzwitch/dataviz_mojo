...
![Layers](out_layers.svg)

## Run it

```sh
mojo run -I . examples/layers.mojo
```
...
[View `layers.mojo` on GitHub](https://github.com/randyzwitch/dataviz_mojo/blob/main/examples/layers.mojo)