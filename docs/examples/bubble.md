...
A scatter plot with both color and size data-driven encoding.

![Bubble Chart](out_bubble.svg)

## Run it

```sh
mojo run -I . examples/bubble.mojo
```
...
[View `bubble.mojo` on GitHub](https://github.com/randyzwitch/dataviz_mojo/blob/main/examples/bubble.mojo)